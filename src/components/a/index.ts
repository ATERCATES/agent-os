/**
 * ClaudeDeck Design System
 *
 * A collection of reusable UI components that follow ClaudeDeck design guidelines:
 * - No strong borders, uses subtle shadows instead
 * - Purple theme (HSL hue 270)
 * - Mobile-first design
 * - Consistent styling across the app
 *
 * All components are prefixed with "A" (for ClaudeDeck).
 */
