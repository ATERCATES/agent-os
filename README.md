...
```bash
# Install globally
npm install -g @saadnvd1/claude-deck
...
Download native desktop apps from [Releases](https://github.com/saadnvd1/claude-deck/releases):
...
```bash
git clone https://github.com/saadnvd1/claude-deck
cd claude-deck
npm install
